...
```bash
git clone https://github.com/SEU_USUARIO/Cavere.git
cd Cavere
```
...
Para criar o usuário administrador inicial no banco de dados:
```bash
...
python app.py
```
O sistema estará disponível em seu navegador no endereço: `http://localhost:5000` (ou na porta configurada).
